  ...
  <!-- COTENT CONTAINER -->
	<div class="container bs-docs-container p-140-cont">
			...
			<div class="col-md-3">
				<div id="sidebar-stiky"  class="bs-sidebar hidden-xs hidden-sm clearfix" role="complementary" >
					...
					<ul id="nav-sidebar" class="nav bs-sidenav blog-categories">
						<li><a href="#college_campus"><span class="blog-cat-icon"><i class="fa fa-angle-right"></i></span>College Campus</a></li>
						<li><a href="#facilities"><span class="blog-cat-icon"><i class="fa fa-angle-right"></i></span>Facilities</a></li>
						<li><a href="#courses"><span class="blog-cat-icon"><i class="fa fa-angle-right"></i></span>Courses</a></li>
      ...
      <div class="col-md-9">
        ...
        <!-- ACCORDIONS  -->	
				<div id="college_campus" class="bs-docs-section mb-100">
